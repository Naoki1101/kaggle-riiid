...
# =================================================================================
# SAINT v9
class CustomTrainDataset13(Dataset):
    def __init__(self, samples, df, cfg=None):
        super(CustomTrainDataset13, self).__init__()
        self.max_seq = cfg.params.max_seq
        self.n_skill = cfg.params.n_skill
...
class CustomTestDataset13(Dataset):
    def __init__(self, samples, df, cfg=None):
        super(CustomTestDataset13, self).__init__()
        self.max_seq = cfg.params.max_seq
        self.n_skill = cfg.params.n_skill
        self.samples = samples
        self.df = df
    ...
    def __getitem__(self, idx):
        ...
        seq_list = dh.load(f'../data/seq13/row_{int(row_id)}.pkl')
...
class CustomTrainDataset14(Dataset):
    def __init__(self, samples, df, cfg=None):
        super(CustomTrainDataset14, self).__init__()
        self.max_seq = cfg.params.max_seq
        self.n_skill = cfg.params.n_skill
        self.step_size = cfg.step_size
        self.samples = samples
...
class CustomTestDataset14(Dataset):
    def __init__(self, samples, df, cfg=None):
        super(CustomTestDataset14, self).__init__()
        self.max_seq = cfg.params.max_seq
        self.n_skill = cfg.params.n_skill
        self.samples = samples
        self.df = df
